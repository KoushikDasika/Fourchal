  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved competition as @competition" do
        ...
        post :create, {:competition => { "startTime" => "invalid value" }}, valid_session
        assigns(:competition).should be_a_new(Competition)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested competition" do
        ...
        Competition.any_instance.should_receive(:update_attributes).with({ "startTime" => "2012-11-22 18:23:42" })
        put :update, {:id => competition.to_param, :competition => { "startTime" => "2012-11-22 18:23:42" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the competition as @competition" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Competition.any_instance.stub(:save).and_return(false)
        put :update, {:id => competition.to_param, :competition => { "startTime" => "invalid value" }}, valid_session
        assigns(:competition).should eq(competition)
      end
